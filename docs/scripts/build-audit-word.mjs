...
const mdPath = path.join(docsDir, 'business-completeness-audit.md');
const outPath = path.join(docsDir, 'business-completeness-audit.docx');
...
<style>
  ...
  h2 { font-size: 15pt; color: #2c5282; margin-top: 18px; }
