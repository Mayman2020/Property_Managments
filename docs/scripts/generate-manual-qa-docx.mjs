...
const MD_PATH = path.join(DOCS_DIR, 'manual-qa-by-role-ar.md');
const OUT_DOCX = path.join(DOCS_DIR, 'Manual-QA-By-Role-ar.docx');
...
async function main() {
  ...
  const html = htmlWrap('دليل الاختبار اليدوي — Role by Role', htmlBody);
