-- V180: Fresh start — purge all business/operational data; keep schema, lookups, permissions, templates, SUPER_ADMIN.
-- Run once via Flyway on backend restart. Password after purge: 12345 (admin@propmgmt.com / superadmin).
