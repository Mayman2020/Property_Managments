package com.propertymanagement.modules.property.attachment.service;
...
public class PropertyAttachmentService {
    ...
    private Long currentUserId() {
        try {
            ...
            if (auth != null && auth.getPrincipal() instanceof com.propertymanagement.modules.user.entity.User u) {
                return u.getId();
            }
