...
export const AppConstants = {
  ...
  API: {
    ...
    HR_DEDUCTION_BY_ID: (id: number) => `/hr/deductions/${id}`,
    ...
    HR_LEAVES: '/hr/leaves',
    HR_LEAVE_BY_ID: (id: number) => `/hr/leaves/${id}`,
    ...
    PAYMENT_SCHEDULE_OVERDUE_REMINDER: (scheduleId: number) => `/payment-schedule/${scheduleId}/overdue-reminder`,
    ...
    VACANCY_UNPUBLISH: (unitId: number) => `/vacancies/by-unit/${unitId}/unpublish`,
