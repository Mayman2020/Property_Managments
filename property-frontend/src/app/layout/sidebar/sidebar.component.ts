...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  readonly navItems: NavItem[] = [
    ...
    { icon: 'meeting_room', labelKey: 'NAV.VACANCIES', route: '/admin/vacancies/list', roles: ['SUPER_ADMIN', 'GENERAL_MANAGER', 'ACCOUNTANT'], permissionKey: 'vacancies', sectionKey: 'NAV_SECTION.CONTRACTS', bypassPermission: true },
    ...
    { icon: 'schedule', labelKey: 'NAV.ATTENDANCE', route: '/admin/hr/attendance', roles: ['SUPER_ADMIN', 'GENERAL_MANAGER', 'HR_OFFICER'], permissionKey: 'hr', sectionKey: 'NAV_SECTION.OPERATIONS', bypassPermission: true },
