...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  readonly navItems: NavItem[] = [
    ...
    { icon: 'person', labelKey: 'NAV.PROFILE', route: '/admin/profile', roles: ['SUPER_ADMIN', 'GENERAL_MANAGER', 'ACCOUNTANT', 'PROCEDURES_CLERK', 'PROPERTY_GUARD', 'OWNER'], permissionKey: 'profile', sectionKey: 'NAV_SECTION.YOU', bypassPermission: true },
    ...
    { icon: 'schedule', labelKey: 'NAV.ATTENDANCE', route: '/admin/hr/attendance', roles: ['SUPER_ADMIN', 'GENERAL_MANAGER', 'ACCOUNTANT'], permissionKey: 'hr', sectionKey: 'NAV_SECTION.OPERATIONS', bypassPermission: true },
